...
const Stats = () => {
  ...
  const prepareMonthlyChartData = () => {
    ...
    const stats = monthlyStats.stats.slice(0, 10) // Top 10 người đăng ký nhiều nhất

    return {
      labels: stats.map(s => s.full_name.split(' ').pop()), // Lấy tên cuối
      datasets: [
        {
          label: 'Bữa sáng',
                      ...
                      <tr>
                        {view === 'daily' ? (
                          ...
                          <>
                            ...
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sáng</th>
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Trưa</th>
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tối</th>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {view === 'daily' ? (
                        dailyStats?.stats?.map((stat, index) => (
                          <tr key={index}>
                            <td className="px-6 py-4 whitespace-nowrap">{stat.meal_name}</td>
                        ...
                        monthlyStats?.stats?.slice(0, 20).map((stat, index) => (
                          <tr key={index}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">{stat.unit_name || '-'}</td>
                            <td className="px-6 py-4 whitespace-nowrap">
