              ...
              {configs.map((config) => (
                <div key={config.config_key} className="border-b border-gray-100 pb-4 last:border-0">
                  ...
                  {editingConfig === config.config_key ? (
                    ...
                    <div className="mt-2">
                      <code className="bg-gray-100 px-3 py-2 rounded-lg font-mono text-gray-800">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Loại bữa</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tên bữa</th>
