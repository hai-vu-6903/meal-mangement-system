...
const UserManager = () => {
  ...
  try {
    let response
    if (editingUser) {
      // Khi update, loại bỏ password nếu rỗng
      const dataToUpdate = { ...formData }
      if (!dataToUpdate.password) delete dataToUpdate.password

      response = await userApi.update(editingUser.id, dataToUpdate)
    } else {
    ...
    <Layout>
      <div className="mb-6 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        ...
        <button
          ...
          className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center justify-center hover:bg-blue-700 w-full lg:w-auto"
        >
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Mã quân nhân</th>
                    <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Họ tên</th>
                    <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Vai trò</th>
                    <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Đơn vị</th>
                    <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Chức vụ</th>
                  ...
                  {users.map((user, index) => (
                    <tr key={user.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-sm text-gray-500 truncate max-w-[150px]">{user.phone}</div>
                      </td>
                      <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
            ...
            <div className="mt-3">
              ...
              <div className="mt-6 flex flex-col sm:flex-row sm:justify-end space-y-3 sm:space-y-0 sm:space-x-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 order-1 sm:order-2"
                >
                  Reset mật khẩu
                </button>
              </div>
